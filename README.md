Welcome to **GodelTech.StoryLine.Rest** library which is set of REST-specific actions and expectations for [StoryLine](https://github.com/DiamondDragon/StoryLine/wiki) framework.
